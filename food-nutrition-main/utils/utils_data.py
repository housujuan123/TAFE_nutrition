...
from mydataset import Nutrition_RGBD, Nutrition
import pdb
import random
...
def get_DataLoader(args):
    ...
    if args.dataset == 'nutrition_rgb':
        ...
        train_transform = transforms.Compose([
                                    ...
                                    transforms.Resize((384, 384)),#swin时用的
                                    # transforms.RandomHorizontalFlip(),
                                    # transforms.CenterCrop((256,256)),
                                    # transforms.ColorJitter(hue=0.05),
                                    transforms.ToTensor(),
        ...
        trainset = Nutrition_RGBD(nutrition_rgbd_ims_root, nutrition_train_rgbd_txt, nutrition_train_txt, enable_flip=True,transform = train_transform)
        testset = Nutrition_RGBD(nutrition_rgbd_ims_root, nutrition_test_rgbd_txt, nutrition_test_txt,enable_flip=False,transform = test_transform)
